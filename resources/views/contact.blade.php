        ...
        <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
				...
				<div class="row m-b30">
                    ...
                    <h2>Our Location</h2>
                        <center>
                        <div class="mapouter"><div class="gmap_canvas"><iframe width="1080" height="380" id="gmap_canvas" src="https://maps.google.com/maps?q=204%20Gravesend%20Road%20Willowvale%2C%20Harare&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.whatismyip-address.com"></a></div><style>.mapouter{position:relative;text-align:right;height:380px;width:1080px;}.gmap_canvas {overflow:hidden;background:none!important;height:380px;width:1080px;}</style></div>
                        </center>
                    <!-- Map part END -->
					</div>
				</div>
