...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('template/plugins/fontawesome/css/font-awesome.min.css') }}">
                    ...
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="dlab-topbar-right">
                            <ul class="social-bx list-inline pull-right">
                                <li><a href="https://www.facebook.com/benosien" class="fa fa-facebook"></a></li>
            ...
            <div class="sticky-header header-curve main-bar-wraper navbar-expand-lg">
                <div class="main-bar bg-primary clearfix ">
                    <div class="container clearfix">
                        <!-- website logo -->
                        <div class="logo-header mostion"><a href="/"><img
                                    src="{{ asset('template/images/loggest.png') }}" width="193" height="89"
                                    alt=""></a>
                        </div>
                        <!-- nav toggle button -->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                            <div class="widget widget_about">
                                <div class="logo-footer"><img src="{{ asset('template/images/loggest.png') }}" alt="">
                                </div>
                                <p><strong>Benosien Motors</strong> offers a one stop auto body repair services. Our
                                    business scope covers from passenger vehicles to commercial vehicles .We have
                                    managed to provide services that have always satisfied our Customers due to well
                                    Advanced and modernized equipment used by well skilled personnel In our workshop</p>
                                <ul class="dlab-social-icon dez-border">
                                    {{-- <li><a class="fa fa-instagram" href="javascript:void(0);"></a></li> --}}
                                    <li><a class="fa fa-facebook" href="https://www.facebook.com/benosien"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                                    ...
                                    @foreach ($works as $work)
                                        ...
                                        @else
                                            <div class="widget-post clearfix">
                                                <div class="dlab-post-media"> <img
                                                        src="storage\{{ $work->image_path }}" alt="" width="200"
                                                        height="143"> </div>
                                                <div class="dlab-post-info">
                                                    <div class="dlab-post-header">
                                                        <h6 class="post-title text-uppercase"><a
                                                                href="/ourwork">{{ $work->title }}</a></h6>
                                                    </div>
                                                    <div class="dlab-post-meta">
                                                        <ul>
                                                            <li class="post-author">By <a href="ourwork">Admin</a></li>
                                                            <li class="post-comment"><i class="fa fa-comments-o"></i> 28
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                            <div class="widget widget_getintuch">
                                ...
                                <ul>
                                    <li><i class="ti-location-pin"></i><strong>address</strong> 204 Gravesend road
                                        Harare ,Zimbabwe</li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-center">
                            <a href="https://designave.co.zw/"><span> Design With <i
                                        class="ti-heart text-primary heart"></i> By DesignAve </span> </a>
                        </div>
